...
menu = "\n++++ User instructions\n \
        Double click a user's name to enter a chat\n \
        To read a poem select poem in the drop down menu and enter a poem number \n \
        To search the chat history select chat history in the drop down menu and enter a term \
        \n\n"
